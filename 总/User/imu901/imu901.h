...
#define imu901_uart_receive(data, len) usart5_getRxData(data, len) /*!< 串口获取接收数据API */
#define imu901_uart_send(data, len) usart5_sendData(data, len)     /*!< 串口i发送数据API */
